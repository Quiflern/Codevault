...
//                 snippets.iter().filter(|s| s.tag == *snippet_tag).collect();
...
//                     } else {
//                         return Err(format!(
//                             " snippet '\x1b[1;33m{}\x1b[0m' ID doesn't exist. enter different ID",
//                             chosen_id
//                         ));
//                     }
//                 } else {
//                     return Err(format!(" please select ID from the list. '\x1b[1;33m{}\x1b[0m' is not a valid choice", chosen_id));
//                 }
